		...
		<div class="form-group">
			...
			<div class="col-sm-8">
				<p class="input-group">
					...
					data-ng-init="vencimiento='<?php echo $this->request->data['Cuota']['vencimiento'] != '0000-00-00' ? $this->request->data['Cuota']['vencimiento'] : '' ?>'"
						datepicker-popup="dd-MM-yyyy" data-ng-model="vencimiento" is-open="popup.vencimiento" min-date="minDate" datepicker-options="dateOptions" data-ng-required="true" current-text="Hoy"
						clear-text="Limpiar" close-text="Cerrar" />
