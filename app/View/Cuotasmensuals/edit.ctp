<div class="cuotasmensuals form">
<?php echo $this->Form->create('Cuotasmensual'); ?>
	<fieldset>
		<legend><?php echo __('Edit Cuotasmensual'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('Cuotasmensual.id')), array(), __('Are you sure you want to delete # %s?', $this->Form->value('Cuotasmensual.id'))); ?></li>
