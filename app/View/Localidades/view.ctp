...
<h2><?php echo __('Localidad'); ?></h2>
	<dl>
		...
		<dd>
			<?php echo h($localidad['Localidad']['postal']); ?>
			&nbsp;
		</dd>
		<dt><?php echo __('Provincia'); ?></dt>
		<dd>
			<?php echo $this->Html->link($localidad['Provincia']['name'], array('controller' => 'provincias', 'action' => 'view', $localidad['Provincia']['id'])); ?>
			&nbsp;
		</dd>
	</dl>
</div>
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete Localidad'), array('action' => 'delete', $localidad['Localidad']['id']), array(), __('Are you sure you want to delete # %s?', $localidad['Localidad']['id'])); ?> </li>
...
<div class="related">
	...
	<?php foreach ($localidad['Socio'] as $socio): ?>
		<tr>
