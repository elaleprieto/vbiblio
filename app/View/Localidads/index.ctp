<div class="localidads index">
	...
	<tr>
		...
		<td><?php echo h($localidad['Localidad']['postal']); ?>&nbsp;</td>
		<td>
		...
		<td class="actions">
			...
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $localidad['Localidad']['id']), array(), __('Are you sure you want to delete # %s?', $localidad['Localidad']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</tbody>
