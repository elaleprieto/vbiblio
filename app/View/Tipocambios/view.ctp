...
<h2><?php echo __('Tipocambio'); ?></h2>
	<dl>
		<dt><?php echo __('Id'); ?></dt>
		<dd>
			<?php echo h($tipocambio['Tipocambio']['id']); ?>
			&nbsp;
		</dd>
		<dt><?php echo __('Abreviatura'); ?></dt>
		<dd>
			<?php echo h($tipocambio['Tipocambio']['abreviatura']); ?>
			&nbsp;
		</dd>
		<dt><?php echo __('Name'); ?></dt>
		<dd>
			<?php echo h($tipocambio['Tipocambio']['name']); ?>
			&nbsp;
		</dd>
	</dl>
</div>
<div class="actions">
	...
	<ul>
		<li><?php echo $this->Html->link(__('Edit Tipocambio'), array('action' => 'edit', $tipocambio['Tipocambio']['id'])); ?> </li>
		<li><?php echo $this->Form->postLink(__('Delete Tipocambio'), array('action' => 'delete', $tipocambio['Tipocambio']['id']), array(), __('Are you sure you want to delete # %s?', $tipocambio['Tipocambio']['id'])); ?> </li>
...
<div class="related">
	...
	<?php foreach ($tipocambio['Socio'] as $socio): ?>
		<tr>
